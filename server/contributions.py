...
_DEMO_NAMES = [
    ...
    "Lakshmi Krishnan", "Rahul Joshi", "Pooja Desai", "Suresh Naidu", "Neha Gupta",
    "Farhan Ali", "Kavya Bhat", "Nikhil Das", "Ritika Bansal", "Mohammed Irfan",
    "Sanjay Pillai", "Aishwarya Hegde", "Varun Malhotra", "Shreya Kulkarni",
    "Harsha Vardhan", "Tanvi Sharma", "Ganesh Iyer", "Ishita Bose", "Rohit Mehta",
    "Anjali Nair", "Deepak Chandra", "Sana Sheikh", "Pranav Kulkarni", "Nandini Rao",
    "Vivek Anand", "Shruti Sinha", "Manish Tiwari", "Divya Suresh", "Arjun Nair",
    "Kavya Rao",
]

# Demo organisation assignments — first 12 names belong to orgs.
_DEMO_ORGS = {
    0: ("company", "Infosys"),
    1: ("company", "Infosys"),
    2: ("college", "IISc Bengaluru"),
    3: ("college", "IISc Bengaluru"),
    4: ("company", "Tata Consultancy Services"),
    5: ("company", "Tata Consultancy Services"),
    6: ("community", "Koramangala Green Collective"),
    7: ("community", "Koramangala Green Collective"),
    8: ("ngo", "Hasiru Dala"),
    9: ("ngo", "Hasiru Dala"),
    10: ("school", "Bishop Cotton School"),
    11: ("school", "Bishop Cotton School"),
}
...
def ensure_seeded():
    ...
    for idx, name in enumerate(_DEMO_NAMES):
        ...
        # Points skew: give a small spread so ranks are meaningful.
